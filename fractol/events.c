...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/11 02:33:58 by moaregra          #+#    #+#             */
/*   Updated: 2024/06/11 06:35:01 by moaregra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mlx_key_gere(t_fractal *fractol)
{
	...
	mlx_hook(fractol->window, DestroyNotify, StructureNotifyMask, close_handler,
		fractol);
	mlx_hook(fractol->window, ButtonPress, ButtonPressMask, mouse_handler,
		fractol);
}
